...
-- NOTE: Admin users are created via admin_user_setup.sql
-- Execute admin_user_setup.sql after objects.sql for admin access
...
ADMIN SETUP: Execute admin_user_setup.sql after objects.sql for admin dashboard access
