...
export class FloorGenerator {
    ...
    generateFloor() {
        ...
        console.log(
            `Floor generated: Floor ${this.floorCount}, starting at Room ${this.currentRoomIndex + 1
            }/${this.currentFloor.length}`
        );
    }
    ...
    nextRoom() {
        ...
        if (this.currentRoomIndex < this.currentFloor.length - 1) {
            ...
            console.log(
                `ROOM PROGRESSION: ${beforeIndex} → ${this.currentRoomIndex} (${this.currentRoomIndex + 1
                }/${this.currentFloor.length})`
            );
        ...
        console.log(
            `Cannot advance: Already at last room (${this.currentRoomIndex + 1}/${this.currentFloor.length
            })`
        );
        return false;
    }
    ...
    setCurrentPosition(floor, roomIndex) {
        try {
            ...
            console.log(
                `Position restored successfully: Floor ${this.floorCount}, Room ${this.currentRoomIndex + 1
                }/${this.currentFloor.length}`
            );
            return true;
        } catch (error) {
