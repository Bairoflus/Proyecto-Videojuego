/**
 * Cop1 enemy class - Floor 2
 * Ranged enemy with burst fire capability → MAPS TO 'rare'
 * Light blue colored rectangle, fast bullets, burst of 10, vision range 100
 */
import { RangedEnemy } from "../../entities/RangedEnemy.js";
import { ENEMY_CONSTANTS_V2 } from "../../../constants/gameConstants.js";
import { Vec } from "../../../utils/Vec.js";

export class Cop1 extends RangedEnemy {
  constructor(position) {
    const config = ENEMY_CONSTANTS_V2.COP1;
    
    super(
      position,
      config.size.width,
      config.size.height,
      "lightblue", // Light blue colored rectangle
      4, // sheetCols
      "cop1", // type
      config.speed,
      config.damage,
      ...
      "cop1" // enemyTypeName → maps to 'rare'
    );
  ...
  updateAnimation() {
    // TODO: Implement cop1 specific animations
  }
}
