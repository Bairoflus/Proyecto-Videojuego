...
const server = http.createServer((req, res) => {
  ...
  if (
    ...
    req.url.startsWith("/utils/") ||
    req.url.startsWith("/classes/") ||
    req.url.startsWith("/constants/")
  ) {
    ...
    res.end(
      "404 Not Found - Frontend server only serves static files",
      "utf-8"
    );
    return;
  }
...
server.listen(PORT, () => {
  ...
  console.log(
    `Registration page: http://localhost:${PORT}/pages/html/register.html`
  );
